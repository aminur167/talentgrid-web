...
import { Person, Envelope, Factory, CircleCheck } from "@gravity-ui/icons";
...
export default function RecruiterSettingsPage() {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-2xl">
      <div>
        <h1 className="text-2xl font-extrabold text-white">Recruiter Settings</h1>
        <p className="text-sm text-neutral-400 mt-1">Manage your recruiter profile and hiring preferences.</p>
      </div>
      ...
      <form onSubmit={handleSave} className="bg-[#141416] border border-white/[0.08] rounded-2xl p-6 flex flex-col gap-5">
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-semibold uppercase tracking-wider text-neutral-400">Recruiter Name</label>
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-semibold uppercase tracking-wider text-neutral-400">Account Email</label>
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-semibold uppercase tracking-wider text-neutral-400">Account Role</label>
          <div className="bg-white/5 border border-white/10 rounded-xl p-3.5 flex items-center justify-between text-xs">
            <span className="text-neutral-300 font-semibold flex items-center gap-1.5">
              <Factory className="w-4 h-4 text-[#ff9838]" /> Employer / Recruiter
            </span>
            <span className="text-[#ff9838] bg-[#ff7a00]/15 border border-[#ff7a00]/30 px-2.5 py-1 rounded-full font-bold">
              Verified
            </span>
          </div>
        </div>
